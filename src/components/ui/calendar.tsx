...
/** shadcn calendar adapted for react-day-picker v9. */
        ...
        <DayPicker
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    "absolute left-4 top-3 z-10 size-7 bg-transparent p-0 opacity-50 hover:opacity-100"
                ),
                button_next: cn(
                    buttonVariants({ variant: "outline" }),
                    "absolute right-4 top-3 z-10 size-7 bg-transparent p-0 opacity-50 hover:opacity-100"
                ),
